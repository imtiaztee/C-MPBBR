...
This repository has been created for experimenting the C-MPBBR scheme proposed in "Coupled Multipath BBR (C-MPBBR): A Efficient Congestion Control Algorithm for Multipath TCP" in Linux Kernel. The detail article has been published in IEEE Access. <br />
***Article link:  https://ieeexplore.ieee.org/document/9187831***
